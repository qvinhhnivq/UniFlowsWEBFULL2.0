    ...
    return `
      <div class="portal-release-card">
        ...
        <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap;">
          ...
          <a href="${window.location.hostname.includes('uniflowslabel.com') ? window.location.protocol + '//uniflowslabel.com/listen/' + encodeURIComponent(releaseSlug) : '/listen/' + encodeURIComponent(releaseSlug)}" target="_blank" class="button" style="padding:6px 14px;font-size:11px;font-weight:bold;background:#000;color:#fff;">SmartLink ↗</a>
        </div>
        <div>
