    ...
    customTracks: [
      {
        ...
        title: 'Vệt Sáng',
        artist: 'Lumi',
        composer: 'Alexandre Vũ & Lumi',
        genre: 'Alternative R&B',
        mood: 'Dreamy · Nocturnal · Cinematic',
        bpm: '92 BPM · E Minor',
        spotifyUrl: 'https://open.spotify.com/track/example-vetsang',
        appleMusicUrl: 'https://music.apple.com/album/example-vetsang',
        youtubeUrl: 'https://youtube.com/watch?v=example-vetsang',
        soundcloudUrl: 'https://soundcloud.com/uniflowslabel/vet-sang',
        audioUrl: '',
        isExternal: false,
        enabled: true
      },
      {
        ...
        title: 'Dải Tần',
        artist: 'MONO//TONE',
        composer: 'MONO//TONE & Alexandre Vũ',
        genre: 'Future Pop',
        mood: 'Energetic · Neon · Modern',
        bpm: '124 BPM · A Major',
        spotifyUrl: 'https://open.spotify.com/track/example-daitan',
        appleMusicUrl: 'https://music.apple.com/album/example-daitan',
        youtubeUrl: 'https://youtube.com/watch?v=example-daitan',
        soundcloudUrl: 'https://soundcloud.com/uniflowslabel/dai-tan',
        audioUrl: '',
        isExternal: false,
        enabled: true
      },
      {
        ...
        title: 'Đường Đua',
        artist: 'KAII',
        composer: 'KAII & Minh Đăng',
        genre: 'Hip-hop / Rap',
        mood: 'Bold · Aggressive · Action',
        bpm: '140 BPM · C Minor',
        spotifyUrl: 'https://open.spotify.com/track/example-duongdua',
        appleMusicUrl: 'https://music.apple.com/album/example-duongdua',
        youtubeUrl: 'https://youtube.com/watch?v=example-duongdua',
        soundcloudUrl: 'https://soundcloud.com/uniflowslabel/duong-dua',
        audioUrl: '',
        isExternal: false,
        enabled: true
      },
      {
        ...
        artist: 'Lumi',
        composer: 'Lumi & Elena Topline',
        genre: 'Acoustic / Soul',
        mood: 'Warm · Intimate · Deep',
        bpm: '78 BPM · D Minor',
        spotifyUrl: 'https://open.spotify.com/track/example-theflow',
        appleMusicUrl: 'https://music.apple.com/album/example-theflow',
        youtubeUrl: 'https://youtube.com/watch?v=example-theflow',
        soundcloudUrl: 'https://soundcloud.com/uniflowslabel/live-the-flow',
        audioUrl: '',
        isExternal: false,
        enabled: true
      }
    ...
    certificates: [
      {
        ...
        artist: 'Lumi',
        composer: 'Alexandre Vũ & Lumi',
        licensee: 'Galaxy Cinema Studio (Phim "Chuyến Tàu Đêm")',
        mediaCategory: 'Phim Điện ảnh / Feature Film (OST & Background Music)',
        territory: 'Toàn cầu (Worldwide)',
        term: 'Vĩnh viễn (In Perpetuity)',
        issueDate: '15/08/2026',
        status: 'VALID',
        authorizedChannels: 'Chiếu rạp toàn cầu, OTT Netflix / VieON, Trailer YouTube & TikTok Campaign'
      },
      {
        code: 'UNI-LC-88BC19',
        ...
        artist: 'KAII',
        composer: 'KAII & Minh Đăng',
        licensee: 'Ogilvy Vietnam (Chiến dịch Honda Winner X 2026)',
        mediaCategory: 'TVC Quảng cáo Thương mại (Commercial Broadcast)',
        territory: 'Việt Nam & Đông Nam Á',
        term: '12 Tháng (Hết hạn: 15/08/2027)',
        issueDate: '10/08/2026',
        status: 'VALID',
        authorizedChannels: 'Truyền hình VTV, HTV, YouTube Ads, TikTok TopView Ads, Billboard LED'
      }
    ],
